...
if __name__ == "__main__":
	...
	#date = date()
	#print('Prayer Times for today in Karaganda/Kazakhstan\n'+ ('='* 41))
	for j in ['Fajr', 'Sunrise', 'Dhuhr', 'Asr', 'Maghrib', 'Isha', 'Midnight']:
		date = datetime.datetime.strptime('31122014', "%d%m%Y").date()
		print(u'\t' + str(date))
		for i in range(365):
			date += datetime.timedelta(days = 1)
			times = prayTimes.getTimes(date, (49, 73), 6);
			#print(u'\n' + str(date))
